...
//         it('should deploy and set the number of campaigns correctly', async function () {
//             const { crowdfunding, owner } = await loadFixture(deployContractAndSetVariables);
//             const numOfCampaigns = await crowdfunding.numberOfCampaigns

//             await expect(crowdfunding.getNumberOfCampaigns()).to.equal(0);
//         });
//     })
